...
return [
    ...
    'settings' => [
        'title' => 'Settings',
        'lead-connectors' => [
            'title' => 'Lead Source Connectors',
            'subtitle' => 'Connect external ad platforms, Indian lead services, webhooks, and QR forms to capture and auto-map leads.',
            'add-connector' => 'Add Lead Connector',
            'create-success' => 'Lead connector created successfully.',
            'update-success' => 'Lead connector updated successfully.',
            'delete-success' => 'Lead connector deleted successfully.',
        ],
        'groups' => [
            'index' => [
    ...
    'leads' => [
        'inbox' => [
            'title' => 'Lead Inbox',
            'leads' => 'Leads',
            'search-placeholder' => 'Search leads by title, contact, or email...',
            'filters' => 'Filters',
            'all' => 'All',
            'apply' => 'Apply Filters',
            'reset' => 'Reset',
            'action-success' => 'Action updated successfully.',
            'bulk-success' => 'Bulk action completed successfully.',
            'lead-not-found' => 'Lead not found.',
            'select-leads' => 'Please select at least one lead.',
            'presets' => [
                'all' => 'All Leads',
                'new' => 'New Leads',
                'unread' => 'Unread',
