...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('moldable_custom_fields', function (Blueprint $table) {
            $table->id();
            $table->foreignId('workspace_id')->constrained('moldable_workspaces')->cascadeOnDelete();
            ...
            $table->index(['workspace_id', 'entity_type', 'sort_order']);
        });
        ...
        DB::table('moldable_industry_templates')->insert([
            [
                ...
                'description' => 'Lead fields, stages, views, and follow-up defaults for interior design sales teams.',
            ...
            [
                ...
                'description' => 'Lead fields and views for property sales teams.',
                'definition' => json_encode([
                    'fields' => [
