...
<template v-else>
    <div class="flex items-center justify-between gap-4 rounded-t-lg border border-b-0 border-gray-300 bg-white px-4 py-2.5 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 max-md:flex-wrap">
        <!-- Left Toolbar -->
